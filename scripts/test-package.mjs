...
try {
  ...
  await writeFile(
    ...
    [
      ...
      '  reindexOReferenceTextareaTokens as reindexRootReferenceTokens,',
      ...
      '  type OInputVariant as ORootInputVariant,',
      '  type OEmptySize as ORootEmptySize,',
      '  type OReferenceTextareaMedia as ORootReferenceTextareaMedia,',
      ...
      '  type OSelectVariant as ORootSelectVariant,',
      '  type OTextareaAutosizeOptions,',
      '  type OTextareaVariant as ORootTextareaVariant,',
      ...
      "import { OInput, type OInputVariant } from '@puzzle-fuzzy/ui/input'",
      ...
      "import { OReferenceTextarea, reindexOReferenceTextareaTokens, type OReferenceTextareaMedia, type OReferenceTextareaProps } from '@puzzle-fuzzy/ui/reference-textarea'",
      "import { OSelect as OSubpathSelect, type OSelectOption, type OSelectValue, type OSelectVariant } from '@puzzle-fuzzy/ui/select'",
      ...
      "import { OTextarea, type OTextareaVariant } from '@puzzle-fuzzy/ui/textarea'",
      ...
      "const rootReferenceMedia: readonly ORootReferenceTextareaMedia[] = [{ id: 'root-one', src: '/root-reference.webp', label: 'Root reference' }]",
      "const referenceMedia: readonly OReferenceTextareaMedia[] = [{ id: 'one', src: '/reference.webp', label: 'One' }]",
      ...
      "const rootInputVariant: ORootInputVariant = 'soft'",
      "const rootSelectVariant: ORootSelectVariant = 'outline'",
      "const rootTextareaVariant: ORootTextareaVariant = 'soft'",
      ...
      "const subpathInputVariant: OInputVariant = 'outline'",
      "const subpathSelectVariant: OSelectVariant = 'soft'",
      "const subpathTextareaVariant: OTextareaVariant = 'outline'",
      "const subpathReferenceVariant: NonNullable<OReferenceTextareaProps['variant']> = 'soft'",
      ...
      "const rootReindexedReference = reindexRootReferenceTokens('[Image 2]', 0)",
      "const subpathReindexedReference = reindexOReferenceTextareaTokens('[Image 2]', 0)",
      ...
      'void rootInputVariant',
      'void rootSelectVariant',
      'void rootTextareaVariant',
      'void subpathInputVariant',
      'void subpathSelectVariant',
      'void subpathTextareaVariant',
      'void subpathReferenceVariant',
      'void rootReindexedReference',
      'void subpathReindexedReference',
      ...
      '    <ORootInput v-model="inputValue" name="rootField" :variant="rootInputVariant" />',
      '  </ORootFormDialog>',
      ...
      '  <ORootReferenceTextarea v-model="text" aria-label="Root reference textarea" :media="rootReferenceMedia" :variant="rootTextareaVariant" />',
      '  <ORootTabs v-model="tab" aria-label="Root tabs" :items="tabItems" />',
      '  <ORootTextarea v-model="text" aria-label="Root textarea" :autosize="textareaAutosize" :variant="rootTextareaVariant" />',
      ...
      '  <OInput v-model="inputValue" aria-label="Subpath input" clearable :variant="subpathInputVariant" />',
      ...
      '  <OReferenceTextarea v-model="text" aria-label="Subpath reference textarea" :media="referenceMedia" :variant="subpathReferenceVariant" />',
      '  <OTabs v-model="tab" aria-label="Subpath tabs" :items="tabItems" />',
      '  <OTextarea v-model="text" aria-label="Subpath textarea" autosize :variant="subpathTextareaVariant" />',
      ...
      '  </OSubpathDropdown>',
      '  <OSubpathSelect v-model="selected" aria-label="Subpath select" :options="selectOptions" :variant="subpathSelectVariant" />',
